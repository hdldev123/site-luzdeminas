...
export default function FinalCTA() {
  return (
    <section id="baixar" className="container-page py-20 sm:py-24">
      <Reveal>
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-brand-green via-brand-dark to-brand-darker px-6 py-14 text-center text-white shadow-soft sm:px-12 sm:py-20">
          <div
            className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-brand-orange/25 blur-3xl"
            aria-hidden="true"
          />
          <div
            className="pointer-events-none absolute -bottom-24 -right-16 h-72 w-72 rounded-full bg-brand-green/40 blur-3xl"
            aria-hidden="true"
          />
